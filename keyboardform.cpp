...
//    m_enter->setLayout(h2);
    ...
    btnWave->setFocusPolicy(Qt::NoFocus);
    ...
    m_btnShift->setFocusPolicy(Qt::NoFocus);
    ...
    m_btnSymbol->setFocusPolicy(Qt::NoFocus);
    ...
    m_btnChange->setFocusPolicy(Qt::NoFocus);
    ...
    m_btnSpace->setFocusPolicy(Qt::NoFocus);
